...
function BookmarkletInstall() {
  ...
  const bookmarkletCode = useMemo(
    () => BOOKMARKLET_TEMPLATE.replace('__APP_ORIGIN__', window.location.origin),
    []
  );
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-4">
        <a
          ...
          aria-label="IdealistaPlus bookmarklet — drag to bookmarks bar"
        >
      ...
      <button
        ...
        aria-label="Copy bookmarklet code to clipboard"
      >
